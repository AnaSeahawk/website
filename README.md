...
People come from many different practices and phases of life.
What connects them is a willingness to **stay with what is happening,** rather than reaching for explanation or escape.
...
The aim is not transcendence.
It is **grounding.**

## A note on time and commitment

This space is for those who understand that some forms of work require **time** — not intensity, not urgency, not constant activity.

Here, time is not something to optimize or consume.
