...
**Starting Volume:** Approximately 2.5 liters of aged plasma.
...
* **Fraction 1: The Active Distillate (Foaming Overflow)**
  * **Yield:** Approximately 500 ml
  * **PPM Reading:** 450 – 466 (Highly volatile, fluctuating before settling around 466).
  * **Characteristics:** Captured early in the process from the initial foaming phase. 
...
* **Fraction 2: The Refined Aqueous Distillate**
  * **Yield:** Approximately 1.25 liters
  * **PPM Reading:** 18
  * **Characteristics:** Collected in the glass carafe as the distillation continued smoothly. Visually super clear.
...
* **Yield:** Approximately 500 ml
* **Filtration:** On the evening of February 18, this concentrate was processed using three coffee filters. 
...
* **PPM Reading:** Tested on February 19. The rich density of this concentrate over-read the meter, exceeding its maximum display limit of 9999 PPM.
* **Applications:** Best suited for topical application on the skin and specifically indicated for wound healing (complementing the wound-cleaning properties of the solar distillates). Additionally, due to its dense mineral profile, it has been successfully utilized in meals to provide a living, umami flavor. 

## 4. Conclusion & Alchemical Insights
Observing the fractionated plasma function simultaneously as a medicinal solvent and a nutrient-dense concentrate provides a profound physical demonstration of the body's internal mechanisms. The solvent-like taste and high volatility of the early distillates reveal the immense, self-cleaning power inherent in the human system. 

The plasma naturally separates into purifying solvents (Solar/Cleaning) and dense, grounding elements (Lunar/Healing). Extracting such rich, umami earth salts from the non-volatile retentate—entirely independent of dietary sodium chloride intake—perfectly illustrates the body's own continuous internal distillation, mineral generation, and purification process.
...
* **Theoretical Expansion:** For a deeper dive into the biophysics and internal Daoist alchemy of this process, read the accompanying essay: [The Alchemy of Plasma: The Fourth Phase of Water and the Refinement of Inner Energy](https://github.com/AnaSeahawk/website/blob/main/BodyAlchemy.md).
* **Future Exploration:** Begin testing the 460 PPM Active Distillate (Fraction 1) as a primary solvent base for upcoming home tinctures, observing how its "living" quality interacts with other botanical elements.
