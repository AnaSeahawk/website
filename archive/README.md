...
`orientation` | `distillation` | `threshold` | `public`
...
`experiment` | `full-cycle` | `threshold` | `public`
...
`synthesis` | `integration` | `major` | `public`
...
`synthesis` | `integration` | `major` | `community`
...
`journal` | `integration` | `threshold` | `public`
...
`journal` | `full-cycle` | `major` | `community`

Continuous 2026 field log holding dreams, food, distillation events, body observations, community movement, and harvest notes.

Threads: `living-record`, `full-cycle`, `restoration-of-continuity`, `community-transmission`
