...
A small bench observation belongs here as a question rather than a conclusion. When Spirit met warm distilled water, a sudden field of fine bubbles appeared across the surface, accompanied by a brief popping sound. Scientifically, the observation sits near interfacial surface-tension behavior: tiny nucleation or degassing events at the boundary where liquids with different temperature, pH, conductivity, volatile load, and charge meet. In the archive's map, the parallel is simple: the charge becomes visible at a surface.
