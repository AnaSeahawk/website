...
**Diet state at start of distillation work:**
- Amaroli practice: ~3.5 years established (4-year mark: April 3, 2026)
- Vegetarian baseline throughout practice
- NaCl removal: approximately 2 years in progress, with occasional social exceptions
- Dairy: warm milk, yogurt, ghee — present
- No meat, no eggs, no alliums
...
*(Retrospective — fill in from notes)*

**2026-03-12** — Apothecary balm made from Saturn retentate. Documented in `apothecary-balm.md`.

**Diet state:**
- NaCl: continuing removal, social exceptions becoming less frequent
- All other parameters stable from February
...
**Diet state as of 2026-04-23:**
- Zero NaCl — no exceptions for minimum 5 months
- Distilled water (structured/deuterium-depleted character) for all cooking and washing
- Primary drinking fluid: distilled plasma (shivambu)
...
- Refined sugar: removed (last few weeks)
- Ice cream: removed (last few weeks)
- No meat, no eggs, no alliums

**Practitioner state 2026-04-23:**
- Active transition symptoms during stimulant removal now resolving
- Head pressure lifting as of today
- Sleep: longer duration, improving quality
- Energy: gradually increasing throughout practice
- Weight: continuing to shift in desired direction for both practitioners
