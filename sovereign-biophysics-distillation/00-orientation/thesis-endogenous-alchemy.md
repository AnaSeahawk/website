...
The key transformation happens during aging.

Native urease enzymes catalyse the hydrolysis of dormant urea into ammonia and carbon dioxide:
...
The charge inversion from +77 mV to -37 mV is the distillation signature. The full run record is in the [experiment report →](../20-experiments/experiment-report-ana-distillation-feb22.md).

---

## What This Means

One body. One run. Not a universal claim.
