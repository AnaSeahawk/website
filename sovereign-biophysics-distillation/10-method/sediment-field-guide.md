...
Fresh plasma typically maintains a slightly acidic pH of 5.5 to 6.8. pH is simply the measure of how acidic or alkaline a liquid is — a scale running from 0 (pure acid) to 14 (pure alkaline), with 7 as neutral. The kidneys regulate the blood at a very precise, slightly alkaline level; the plasma they excrete carries the acid byproducts of daily metabolism, which is why it begins on the slightly acidic side of neutral.
...
These form the primary component of the thick, milky cloudiness that settles as bottom sludge. "Amorphous" simply means shapeless — unlike struvite's precise geometry, these phosphate deposits have no defined crystal structure. They appear as loose, greyish-white or pale yellow sediment — heavy but not compact, easily stirred up when the jar is moved but quick to resettle when left undisturbed.
...
The body constantly renews its internal linings. The kidney tubules, the bladder wall, and the urethra are all lined with **epithelial cells** — a single-cell-thick interior skin, like the skin on the inside. These cells shed continuously as part of normal renewal, just as the outer skin sheds invisibly each day. In aged plasma they appear as wispy, cobweb-like material — fine organic threads floating just above the heavier mineral layers. The texture is distinctly different from crystalline precipitates: softer, more organic, sometimes slightly sticky or thread-like when stirred.

### Protein Aggregates
Fresh plasma carries small amounts of protein — enzymes, transport molecules, cellular repair factors. These proteins are large, folded structures that hold their precise three-dimensional shape only within a narrow pH range. When the fluid alkalinises significantly, these proteins **denature** — they unfold, losing their functional shape — and then **aggregate**, clumping together into visible masses. This is the same process that makes egg white solidify when heated, except here it is pH rather than heat driving the change. The resulting clumps add density and slight tackiness to the bottom sludge layer, creating a matrix that can trap other precipitates and give the wet sediment a more cohesive, gel-like consistency.
...
**Protein aggregation increases.** Oxidised fat fragments bond with proteins in the fluid, causing more pronounced protein aggregate formation. This shows as increased density and stickiness in the wet bottom sludge, and a heavier, more cohesive resin in the dry residue.
...
**Pellicle disruption and hepatic stress.** "Hepatic" means of the liver — from the Greek *hepar*. The liver (called *yakrit* in Sanskrit, the primary seat of *pachaka pitta* — the transforming fire) is the body's master processing organ. Every drop of blood leaving the digestive tract passes through the liver before reaching general circulation. It filters toxins, converts nutrients, produces bile for fat digestion, and transforms every substance the body encounters. When alcohol enters the system, the liver immediately prioritises its breakdown above all other functions — converting ethanol first into acetaldehyde (a toxic intermediate that produces the symptoms of intoxication) and then into acetate. This sequencing taxes the liver heavily, pulling its processing resources away from normal lipid and protein management. The result is visible in the jar: the surface pellicle after alcohol periods may be thinner, less stable, and more fragmented, and the protein aggregate content in the mid-column and sludge layers tends to increase. The liver is speaking through the fluid.
