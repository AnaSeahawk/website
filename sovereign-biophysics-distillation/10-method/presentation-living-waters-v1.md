...
A single distillation concentrates. A second distillation refines. This is why the alchemists spoke of flying the second eagle — running the distillate back through the process again. The subtle becomes more subtle. The solar fraction and the lunar fraction become distinct. What was mixed becomes legible as two things. In Ayurvedic terms this is *bhāvana* — repeated processing to refine the essence at each pass. The body itself works this way: nothing is refined in a single pass.
