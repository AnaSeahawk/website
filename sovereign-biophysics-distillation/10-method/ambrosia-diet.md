...
*The diet is not a discipline imposed on the practice. It is what the practice asks for when the circuit is running.*
...
This preparation has deep roots. Virtually every grain-eating culture that predates industrial milling discovered that grain treated with alkaline water before cooking is a different food. In Mesoamerica the process was *nixtamalization* — corn soaked and cooked in calcium hydroxide (slaked lime, pH 11–12) until the outer hull loosened and released. In North American and Appalachian traditions, wood ash water — *lixivium*, primarily potassium hydroxide — served the same purpose for hominy. West African grain traditions use plant ash potash to soften grains before fermented preparations. The Scandinavian preservation of fish in lye — *lutefisk* — is the same mechanism applied to protein rather than starch. The ingredient and the grain change; the principle does not.

The chemistry is consistent across traditions. The outer husk of a grain kernel is composed of three interlocking compounds: cellulose, hemicellulose, and lignin. Hemicellulose acts as the binding agent — the matrix that holds the structural layers together and locks the outer bran against the endosperm beneath. Alkalinity dissolves hemicellulose by cleaving the ester bonds that connect it to the lignin network. When those bonds break, the outer layer loses cohesion. The grain opens. Water and heat penetrate what they could not before. This is why properly soaked grain cooks differently — not just faster, but to a deeper softness, because the outer barrier is no longer resisting the process. Starch gelatinization, the absorption of moisture into the interior, begins from a different starting position.

There is also the question of what the outer layer contains. Phytic acid — the grain's primary phosphorus storage compound — is concentrated in the bran and aleurone layers. In its intact form it binds calcium, iron, and zinc within the grain, making them unavailable during digestion. When alkaline treatment compromises or removes the outer layers, phytic acid is reduced along with them. The grain's own mineral content becomes more available. What is consumed more closely represents what the grain actually holds.

The Solar spirit is a different alkaline agent than traditional lye. It is ammonium hydroxide — a weak base at pH 10–10.3, not the pH 11–13 of potassium or calcium hydroxide. It does not dissolve hemicellulose at the speed or depth of strong lye. In that comparison, it is the lesser reagent. But the medium changes the equation.

Traditional lye preparations were made with well water, spring water, or river water — water carrying dissolved calcium, magnesium, and bicarbonate minerals. These dissolved minerals buffer alkalinity: when an alkaline agent is added to mineral-laden water, the dissolved carbonates consume a portion of it before it reaches the grain. The water's own chemistry partially neutralises what was added. The available alkalinity is lower than the nominal pH suggests.
...
What this looks like in practice varies by person. The observation here is one practitioner's experience and is offered only as that. What it points toward is not a rule but a question worth holding: *when the body is genuinely nourished at depth, what does it actually ask for?*

The answer the practice gives is worth discovering directly.
...
These are not dietary philosophies that happened to align. They are records of the same observation, made by practitioners working with the same practice, across traditions that did not share texts.
