...
# The Living Loop
## Cohobation as Daily Practice — A Practitioner's Account

*Single-practitioner record. Four years of continuous practice across changing conditions and geographies. This document is a living record — filled in incrementally as the practice evolves.*

*Not a protocol to follow. A description of how this practice actually lives.*

---

## What the Loop Is

The closed loop is not a technique applied to a practice. It is the practice itself.

The body produces. The production is collected, aged, distilled, and returned — as drinking water, as food preparation, as oral care, as skin, as cleaning, as garden, as laundry. Nothing leaves the loop by accident. What the body makes comes back through every available channel, refined each time it passes through.

After four years, this is not a discipline. It is simply how a day moves.
...
**Yoni:**
The yoni wash has been part of the practice at different periods, and the history of it follows the same arc as every other application: the concentrated form was tried first, the lesson came through the body, and the practice refined itself from there.
...
After that experience the rule became simple: yoni application only with fresh plasma, and only when the plasma itself was warm and sweet-tasting. If the morning collection had that quality — mild, clean, no sharpness — it was appropriate. If it did not, the practice was skipped entirely. This went on intermittently for some time. The application was always gentle, never prolonged, and the body's response was the guide.

Then a long gap. The practice was not used for a significant period.

The return to it came in Sarandë, April 2026, using Lunar essence for the first time in this context. The experience was entirely different from anything that had come before. The essence brought a warmth that was simultaneously cooling — a quality that is difficult to name accurately but is immediately recognisable when experienced. There was no sharpness, no burning, no need for anything to follow it. The tissue received it differently than it had received aged or fresh plasma. Something about the distillation process has removed whatever it is that made concentration caustic while keeping — or concentrating — whatever it is that made the application valuable.

I did not keep it in long. I could have. There was no discomfort that would have stopped it. I got up and noticed the gravity of the fluid felt different — a quality I had not encountered before with other applications. I made it to the bathroom and collected what came out in a jar. Approximately 100ml. The colour was like skim milk — the Lunar essence alone is clear, so the colour shift was the body's contribution: the tissue had left something of itself in what it returned. The taste was sweet. I gave some to my partner to try; he said it tasted like me. I drank the rest.

The two nights of unusually vivid dreams followed immediately after.

*On concentrations for internal tissue:* The same principle that governs nasal application applies here, more strongly. Aged plasma is too concentrated for internal mucosal tissue — the alkalinity and mineral load that makes it effective on intact external skin becomes caustic in contact with the thinner, more permeable tissue of the vaginal canal. The Solar spirit is not appropriate here for the same reason as for the nose, with the additional consideration that the volatility would be intensified by the enclosed warm environment. The Lunar essence is the appropriate fraction for internal application — very low mineral load, structurally clean, close to the body's own fluid chemistry. Fresh plasma, when genuinely mild and sweet, is the appropriate starting point and remains a usable option. Condition of the plasma is the indicator, not a schedule.
...
## When You Have Space — The Full Practice

The first two years of this practice were different.
...
## What the Practice Has Taught About Place

The two years in a fixed location showed what the practice becomes when it has space. The nomadic years showed what it requires at its irreducible minimum. The vision for the permanent place comes from both — from knowing what the stripped practice looks like and what the full practice makes possible.
